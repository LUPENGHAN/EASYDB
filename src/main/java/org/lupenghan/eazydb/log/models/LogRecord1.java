...
public class LogRecord1 {
    ...
    public static LogRecord1 createRedoLog(long xid, int pageID, short offset, byte[] newData) {
        LogRecord1 log = new LogRecord1();
    ...
    public static LogRecord1 createUndoLog(long xid, byte operationType, short offset, byte[] undoData, int pageID) {
        LogRecord1 log = new LogRecord1();
    ...
    public static LogRecord1 deserialize(byte[] entry) {
    ...
    private static LogRecord1 deserializeRedoLog(byte[] data) {
    ...
    private static LogRecord1 deserializeUndoLog(byte[] data) {
        ByteBuffer buffer = ByteBuffer.wrap(data);
        LogRecord1 log = new LogRecord1();
        log.logType = TYPE_UNDO;
        log.xid = buffer.getLong();
